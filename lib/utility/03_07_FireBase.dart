...
class FirestoreMethod {
  ...
  static final pedometer_manageRef = _firestoreInstance.collection('PEDOMETER_MANAGEMENT_TBL');
  ...
  static Future<Pedmeter> getPedmeter() async {
    ...
    if(PreSumSteps >= PrezentVpedometer){
      ...
      NextPresentValue = OtherMethod().todofukenHenkanMethod(PrezentVnextPrefectures);
    }
